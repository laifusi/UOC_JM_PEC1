...
namespace Complete
{
    public class TankShooting : MonoBehaviour
    {
        ...
        public Rigidbody m_RedShell;                // Prefab of the red shell.
        ...
        private string m_AltFireButton;             // The input axis that is alternatively used for launching shells.
        ...
        private void Start ()
        {
            ...
            //The alternative fire button is also based on the player number.
        ...
        private void Fire ()
        {
            ...
            Rigidbody shellInstance =
                Instantiate (m_ShellToUse, m_FireTransform.position, m_FireTransform.rotation) as Rigidbody;
